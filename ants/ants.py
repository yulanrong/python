    ...
    def action(self, colony):
        ...
        if self.true_queen==True:
            ...
            while location is not None:
                if location.ant and location.ant.is_double==False:
                    location.ant.damage *= 2
                    location.ant.is_double=True
                    if location.ant.is_container:
                        if location.ant.contained_ant:
                            if location.ant.contained_ant.is_double==False:
                                location.ant.contained_ant.damage *=2
                                location.ant.contained_ant.is_double=True
                elif location.ant and location.ant.is_container:
                    if location.ant.contained_ant.is_double==False:
                        location.ant.contained_ant.damage *= 2
                        location.ant.contained_ant.is_double=True
...
def make_scare(action, bee):
    ...
    "*** YOUR CODE HERE ***"
    def scare(colony):
        if bee.place.entrance == Hive:
            return
        else:
            if bee.been_scared==False:
                if bee.direction=='forward':
